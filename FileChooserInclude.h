...
#ifndef _____PROJECTNAME_egnixfilechooserinclude_____ColorPick__
#define _____PROJECTNAME_egnixfilechooserinclude_____ColorPick__
...
#elif __WINDOWS__
#include "Platform/WIN/WinFileChooser.h" // platform specific include!
#elif __LINUX__
