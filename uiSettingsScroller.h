...
struct uiSettingsScroller{  // we will become uxInstance->settingsScroller - and is pretty much singleton....
    ...
    const char* appVersion = "Version-1.0"; // no spaces allowed or we won't be able to open URL (update: test it but do Open url in ogg now replaces spaces and newlines...)
